package com.eresearch.author.matcher.db.scheduler;
...
public class DbCleaner {
     ...
     */
    @Scheduled(cron = "0 0/10 * * * *") //every ten minutes, but to be safe for transactions, multi-access, etc., will should do it off-days.
        ...
        transactionTemplate.execute(new TransactionCallbackWithoutResult() {
            ...
            protected void doInTransactionWithoutResult(TransactionStatus transactionStatus) {
                ...
                try {
                    ...
                    jdbcTemplate.update(authorMatcherDao.getDeleteQueryForSearchResultsTable());
                    jdbcTemplate.update(authorMatcherDao.getResetAutoIncrementForSearchResultsTable());
